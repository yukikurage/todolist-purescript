...
(function($PS) {
  ...
  var AddTask = (function () {
      ...
      AddTask.value = new AddTask();
      return AddTask;
  })();
  var SetTaskName = (function () {
      function SetTaskName(value0) {
          this.value0 = value0;
      };
      SetTaskName.create = function (value0) {
          return new SetTaskName(value0);
      };
      return SetTaskName;
  })();
  var DeleteTask = (function () {
      function DeleteTask(value0) {
          this.value0 = value0;
      };
      DeleteTask.create = function (value0) {
          return new DeleteTask(value0);
      };
      return DeleteTask;
  })();
  var FinishTask = (function () {
      function FinishTask(value0) {
          this.value0 = value0;
      };
      FinishTask.create = function (value0) {
          return new FinishTask(value0);
      };
      return FinishTask;
  })();
  var withItr = function (xs) {
      ...
      return Data_Array.zipWith(f)(Data_Array.range(0)(len - 1 | 0))(xs);
  };
  var renderTask = function (taskItr) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("task") ])(Data_Array.cons(Halogen_HTML_Core.text(Data_Show.show(Data_Show.showString)(taskItr.val.name)))((function () {
          if (taskItr.val.isFinished) {
              return [ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new DeleteTask(taskItr.itr);
              }) ])([ Halogen_HTML_Core.text("\u524a\u9664") ]) ];
          };
          return [ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new FinishTask(taskItr.itr);
          }) ])([ Halogen_HTML_Core.text("\u5b8c\u4e86") ]) ];
      })()));
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("\u30bf\u30b9\u30af\u4e00\u89a7") ]), Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderTask)(withItr(Data_Maybe.fromMaybe([  ])(state.tasks)))), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("\u30bf\u30b9\u30af\u540d"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(state.newTaskName), Halogen_HTML_Events.onValueInput(function (str) {
          return new SetTaskName(str);
      }) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return AddTask.value;
      }) ])([ Halogen_HTML_Core.text("\u8ffd\u52a0") ]) ]) ]);
  };
  var initialState = function (v) {
      return {
          newTaskName: "",
          tasks: Control_Applicative.pure(Data_Maybe.applicativeMaybe)([  ])
      };
  };
  var handleAction = function (v) {
      if (v instanceof AddTask) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              return {
                  tasks: Data_Functor.map(Data_Maybe.functorMaybe)(Data_Array.cons({
      ...
      if (v instanceof SetTaskName) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $12.newTaskName = v.value0;
              return $12;
          });
      };
      if (v instanceof DeleteTask) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              var $16 = {};
              for (var $17 in state) {
              ...
              $16.tasks = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.deleteAt(v.value0))(state.tasks);
              return $16;
          });
      };
      if (v instanceof FinishTask) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              var $23 = {};
              for (var $24 in state) {
              ...
              $23.tasks = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.modifyAt(v.value0)(function (v2) {
                  var $20 = {};
                  for (var $21 in v2) {
      ...
      throw new Error("Failed pattern match at Main (line 93, column 16 - line 99, column 79): " + [ v.constructor.name ]);
  };
