...
(function($PS) {
  ...
  var withItr = function (xs) {
      return Data_Array.zipWith(function (v) {
          return function (v1) {
              return {
                  itr: v,
                  val: v1
      ...
      })(Data_Array.range(0)(Data_Array.length(xs) - 1 | 0))(xs);
  };
  var renderTask = function (taskItr) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("task") ])(Data_Array.cons(Halogen_HTML_Core.text(taskItr.val.name))((function () {
  ...
  var handleAction = function (v) {
      ...
      if (v instanceof DeleteTask) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              ...
              $18.tasks = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.deleteAt(v.value0))(state.tasks);
              return $18;
          });
      };
      if (v instanceof FinishTask) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              ...
              $25.tasks = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.modifyAt(v.value0)(function (v2) {
                  var $22 = {};
                  for (var $23 in v2) {
      ...
      throw new Error("Failed pattern match at Main (line 88, column 16 - line 94, column 79): " + [ v.constructor.name ]);
  };
